...
JSDOC.Symbol.prototype.init = function() {
    ...
    this.inheritsFrom = [];
    this.isa = "OBJECT";
    this.isClassConstant = false;
    this.isConstant = false;
    this.isEnumeration = false;
    this.isEvent = false;
    this.isGlslConstant = false;
    this.isGlslFunction = false;
    this.isGlslStruct = false;
    this.isGlslUniform = false;
    this.hasPerformance = false;
...
JSDOC.Symbol.prototype.setTags = function() {
    ...
    */
    ...
    // @classConstant
    var classConstant = this.comment.getTag("classConstant");
    if (classConstant.length) {
        this.isa = "CONSTRUCTOR";
        this.isClassConstant = true;
        this.classDesc = classConstant[0].desc; // desc can't apply to the constructor as there is none.
    }
    ...
    // @glslStruct
    var glslStruct = this.comment.getTag("glslStruct");
    if (glslStruct.length) {
        this.isa = "CONSTRUCTOR";
        this.classDesc = glslStruct[0].desc;
        this.isGlslStruct = true;
    }
    
    // @immutable 
    var immutable = this.comment.getTag("immutable");
    if (immutable.length) {
