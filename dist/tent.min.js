...
tent.mixin=function(a,b){for(var c in b.prototype)if(b.prototype.hasOwnProperty(c))a.prototype[c]=b.prototype[c];return a};tent.combineOptions=function(){for(var a={},b=0,c=arguments.length;b<c;b++){var d=arguments[b],g;for(g in d)if(d.hasOwnProperty(g))a[g]=d[g]}return a};
...
return a};tent.entities.Context.prototype.first=function(a){for(var b in this.__collections__){var c=this.__collections__[b].items.first(a);if(c)return c}return null};tent.entities.Context.prototype.find=function(a){if(a instanceof Array){for(var b=[],c=0,d=a.length;c<d;c++)b[c]=this.find(a[c]);return b}else{for(b in this.__collections__)if(c=this.__collections__[b].find(a))return c;return null}};tent.entities.Context.prototype.filter=function(a){var b=[],c;for(c in this.__collections__)b.push.apply(b,
this.__collections__[c].items.filter(a));return b};tent.entities.Context.prototype.contains=function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(b)if(b.__collection__){if(this.__collections__[b.__collection__.name]!=b.__collection__)return false}else if(b instanceof tent.entities.Type){if(this.__types__[b.name]!=b)return false}else if(b instanceof tent.entities.Collection){if(this!=b.context)return false}else return false;else return false}return true};tent.entities.Context.prototype.getCollection=
function(a,b){if(b){if(a&&!a instanceof tent.entities.Type)throw"provided type is not a Type instance";}else if(a)if(a instanceof tent.entities.Type)b=a.name;else if(typeof a=="string"){b=a;a=null}else throw"provide a Type or name to create a Collection";else b="_Object";if(!this.__collections__[b]){this.__collections__[b]=new tent.entities.Collection(this,a,b);for(var c=b;this[c];)c+="_";this[c]=this.__collections__[b]}return this.__collections__[b]};tent.entities.Context.prototype.pushModel=function(a){if(a)if(a.types)for(var b in a.types)this.push(new tent.entities.Type(b,
a.types[b]))};tent.entities.Context.prototype.push=function(){for(var a=0;a<arguments.length;a++)if(arguments[a]instanceof Array)throw"cannot push arrays into a Context";else if(arguments[a].__collection__){if(arguments[a].__collection__.context!=this)throw"cannot push this item, it belongs to another Context";}else if(arguments[a]instanceof tent.entities.Type){if(!arguments[a].name)throw"cannot add an EntityType without name";if(this.__types__[arguments[a].name])if(this.__types__[arguments[a].name]==
arguments[a])continue;else throw'EntityType "'+arguments[a].name+'" already exists';this.__types__[arguments[a].name]=arguments[a];this.getCollection(arguments[a])}else if(arguments[a]instanceof tent.entities.Context)throw"cannot add an EntityContext to an EntityContext";else if(typeof arguments[a]=="object"){var b=arguments[a].__entityType__;if(b)if(this.__types__[b.name]){if(this.__types__[b.name]!=b)throw'cannot add, object EntityType "'+b.name+'" differs from the Context one';}else this.__types__[b.name]=
b;this.getCollection(b).push(arguments[a])}};tent.entities.Context.prototype.attach=function(){for(var a=0;a<arguments.length;a++)if(arguments[a]instanceof Array)throw"cannot attach arrays";else if(arguments[a].__collection__){if(arguments[a].__collection__.context!=this)throw"cannot attach this item, it belongs to another Context";}else if(arguments[a]instanceof tent.entities.Type)throw"cannot attach EntityTypes";else if(arguments[a]instanceof tent.entities.Context)throw"cannot attach an EntityContext to an EntityContext";
else if(typeof arguments[a]=="object"){var b=arguments[a].__entityType__;if(b)if(this.__types__[b.name]){if(this.__types__[b.name]!=b)throw'cannot add, object EntityType "'+b.name+'" differs from the Context one';}else this.__types__[b.name]=b;this.getCollection(b).attach(arguments[a])}};tent.entities.Context.prototype.remove=function(){for(var a=0;a<arguments.length;a++)if(arguments[a]instanceof tent.entities.Type)throw"cannot remove EntityTypes";else if(arguments[a]instanceof tent.entities.Context)throw"cannot remove an EntityContext from an EntityContext";
else typeof arguments[a]=="object"&&arguments[a].__collection__&&arguments[a].__collection__.remove(arguments[a])};tent.entities.Context.prototype.detach=function(){for(var a=0;a<arguments.length;a++){if(arguments[a]instanceof Array)throw"cannot detach arrays";if(arguments[a]instanceof tent.entities.Type)throw"cannot detach EntityTypes";else if(arguments[a]instanceof tent.entities.Context)throw"cannot detach an EntityContext from an EntityContext";else typeof arguments[a]=="object"&&arguments[a].__collection__&&
arguments[a].__collection__.detach(arguments[a])}};tent.entities.Context.prototype.detachAll=function(){for(var a=false,b=0;b<this.__collections__.length;b++)if(this.__collections__[b].detachAll())a=true;return a};tent.entities.Context.prototype.touch=function(){if(this.changeHandler)return this.changeHandler.touch.apply(this.changeHandler,arguments)};tent.entities.Context.prototype.__cascadePush__=function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(b.__entityType__)for(var c in b.__entityType__.properties)if(b[c]!==
null&&typeof b[c]=="object"){var d=b.__entityType__.properties[c];if(d.cascadePush){var g=null;if(d.collection)g=this.__collections__[d.collection]||this.getCollection(d.collection);if(b[c]instanceof Array){if(d.cardinality&&d.cardinality[1]!="1")g?g.push.apply(g,b[c]):this.push.apply(this,b[c])}else g?g.push(b[c]):this.push(b[c])}}}};tent.entities.Context.prototype.__cascadeAttach__=function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(b.__entityType__)for(var c in b.__entityType__.properties)if(b[c]!==
null&&typeof b[c]=="object"){var d=b.__entityType__.properties[c];if(d.cascadeAttach){var g=null;if(d.collection)g=this.__collections__[d.collection]||this.getCollection(d.collection);if(b[c]instanceof Array){if(d.cardinality&&d.cardinality[1]!="1")g?g.attach.apply(g,b[c]):this.attach.apply(this,b[c])}else g?g.attach(b[c]):this.attach(b[c])}}}};tent.entities.Context.prototype.__cascadeRemove__=function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(b.__entityType__)for(var c in b.__entityType__.properties)if(b[c]!==
null&&typeof b[c]=="object"){var d=b.__entityType__.properties[c];if(d.cascadeRemove)if(b[c]instanceof Array)d.cardinality&&d.cardinality[1]!="1"&&this.remove.apply(this,b[c]);else this.remove(b[c])}}};tent.entities.Context.prototype.__cascadeDetach__=function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(b.__entityType__)for(var c in b.__entityType__.properties)if(b[c]!==null&&typeof b[c]=="object"){var d=b.__entityType__.properties[c];if(d.cascadeDetach)if(b[c]instanceof Array)d.cardinality&&
d.cardinality[1]!="1"&&this.detach.apply(this,b[c]);else this.detach(b[c])}}};tent.entities.Context.prototype.trackChanges=function(){if(!this.changeHandler){this.changeHandler=new tent.entities.ContextChangeHandler(this);this.changeHandler.init()}};tent.entities.Context.prototype.hasChanges=function(){return!!(this.changes&&this.changes.items.length>0)};tent.entities.Context.prototype.markAsSaving=function(){for(var a=0;a<arguments.length;a++){var b=arguments[a];if(b instanceof Array)this.markAsSaving.apply(this,
b);else{if(b.__syncState__&&b.__syncState__.saving)throw"cannot start saving, item already being saved";b.__syncState__={saving:true}}}};tent.entities.Context.prototype.acceptAllChanges=function(){this.changeHandler&&this.changeHandler.acceptAllChanges()};tent.entities.Context.prototype.acceptChanges=function(){this.changeHandler&&this.changeHandler.acceptChanges.apply(this.changeHandler,arguments)};tent.entities.EntityLink=function(a,b,c,d){this.from=a;this.to=b;this.propertyName=c;this.__changeState__=
d||tent.entities.ChangeStates.DETACHED};tent.entities.ContextChanges=function(a){this.context=a;this.items=[];tent.arrays.extend(this.items)};tent.entities.ContextChanges.prototype.toString=function(){for(var a=new tent.coreTypes.NameCounter,b=0,c=this.items.length;b<c;b++)a.add(tent.entities.ChangeStates.getName(this.items[b].__changeState__)+"."+this.items[b].__collection__.name);return a.toString()};tent.entities.ContextChangeHandler=function(a){this.context=a};tent.entities.ContextChangeHandler.prototype.isDetached=
function(a){return!a.__changeState__||a.__changeState__==tent.entities.ChangeStates.DETACHED};tent.entities.ContextChangeHandler.prototype.bindArrayProperties=function(a){if(a.__entityType__)for(var b in a.__entityType__.properties){var c=a.__entityType__.properties[b];if(c.cardinality&&c.cardinality.substr(1,1)!="1"&&a[b]instanceof Array){a[b].__parent__=a;a[b].__propertyName__=b;tent.changes.bind(a[b],this)}}};tent.entities.ContextChangeHandler.prototype.unbindArrayProperties=function(a){if(a.__entityType__)for(var b in a.__entityType__.properties){var c=
a.__entityType__.properties[b];c.cardinality&&c.cardinality.substr(1,1)!="1"&&a[b]instanceof Array&&tent.changes.unbind(a[b],this)}};tent.entities.ContextChangeHandler.prototype.trackComplexProperties=function(a){if(a.__entityType__)for(var b in a.__entityType__.properties)a.__entityType__.properties[b].complex&&typeof a[b]=="object"&&tent.changes.track(a[b],{deep:true,attachedObjects:false,parentObject:a,parentObjectPropertyName:b});else for(b in a)b.substr(0,1)!=="_"&&a.hasOwnProperty(b)&&typeof a[b]==
"object"&&tent.changes.track(a[b],{deep:true,attachedObjects:false,parentObject:a,parentObjectPropertyName:b})};tent.entities.ContextChangeHandler.prototype.setAdded=function(a){if(a.__changeState__!=tent.entities.ChangeStates.ADDED)if(a.__collection__)if(a.__collection__.context==this.context){a.__changeState__=tent.entities.ChangeStates.ADDED;if(!this.context.changes)this.context.changes=new tent.entities.ContextChanges(this.context);this.context.changes.items.pushUnique(a)}else throw"cannot set this item as ADDED, it belongs to another Context";
else a.__changeState__=tent.entities.ChangeStates.ADDED};tent.entities.ContextChangeHandler.prototype.setRemoved=function(a){if(!(this.isDetached(a)||a.__changeState__==tent.entities.ChangeStates.DELETED))if(a.__collection__)if(a.__collection__.context==this.context)if(a.__changeState__==tent.entities.ChangeStates.UNCHANGED||a.__changeState__==tent.entities.ChangeStates.MODIFIED){a.__changeState__=tent.entities.ChangeStates.DELETED;if(a.__syncState__&&a.__syncState__.saving)a.__syncState__.deletedWhileSaving=
true;if(!this.context.changes)this.context.changes=new tent.entities.ContextChanges(this.context);this.context.changes.items.pushUnique(a)}else{if(a.__changeState__==tent.entities.ChangeStates.ADDED){this.context.changes.items.remove(a);if(a.__syncState__&&a.__syncState__.saving){a.__syncState__.deletedWhileSaving=true;a.__changeState__=tent.entities.ChangeStates.DELETED;this.context.changes.items.pushUnique(a)}else{a.__changeState__=tent.entities.ChangeStates.DETACHED;delete a.__collection__;if(!this.context.changes)this.context.changes=
new tent.entities.ContextChanges(this.context)}}}else throw"cannot set this item as DELETED, it belongs to another Context";else{a.__changeState__=tent.entities.ChangeStates.DELETED;if(a.__syncState__&&a.__syncState__.saving)a.__syncState__.deletedWhileSaving=true}};tent.entities.ContextChangeHandler.prototype.touch=function(){for(var a=0,b=arguments.length;a<b;a++)if(arguments[a].__collection__&&arguments[a].__collection__.context==this.context)if(arguments[a].__changeState__===tent.entities.ChangeStates.UNCHANGED){if(!this.context.changes)this.context.changes=
new tent.entities.ContextChanges(this);arguments[a].__changeState__=tent.entities.ChangeStates.MODIFIED;this.context.changes.items.pushUnique(arguments[a])}else if(arguments[a].__syncState__&&arguments[a].__syncState__.saving&&(arguments[a].__changeState__===tent.entities.ChangeStates.MODIFIED||arguments[a].__changeState__===tent.entities.ChangeStates.ADDED))arguments[a].__syncState__.changedWhileSaving=true};tent.entities.ContextChangeHandler.prototype.itemAdded=function(a){if(this.isDetached(a))this.setAdded(a);
else if(a.__changeState__!=tent.entities.ChangeStates.UNCHANGED){if(!this.context.changes)this.context.changes=new tent.entities.ContextChanges(this.context);this.context.changes.items.pushUnique(a)}if(a.__changeState__!=tent.entities.ChangeStates.DELETED){tent.changes.bind(a,this);this.bindArrayProperties(a);this.trackComplexProperties(a)}};tent.entities.ContextChangeHandler.prototype.itemAttached=function(a){if(this.isDetached(a))a.__changeState__=tent.entities.ChangeStates.UNCHANGED;this.itemAdded(a)};
...
if(c.collection&&d.__collection__.name!=c.collection)throw"cannot link an object of collection "+c.collection+' to property "'+c+'"';}if(!d.__collection__&&c.onLinkPush){d.__entityType__&&this.context.push(d.__entityType__);if(c.collection){if(!this.context.__collections__[c.collection])throw Error('Collection "'+c.collection+'" not found in this Context');this.context.__collections__[c.collection].push(d)}else this.context.push(d)}if(c.trackLinks){c=null;for(var g=this.context.changes.items.length-
1;g>=0;g--){var j=this.context.changes.items[g];if(j instanceof tent.entities.EntityLink&&j.from===a&&j.to===d&&j.propertyName==b){c=j;break}}if(c){if(c.__changeState__==tent.entities.ChangeStates.DELETED)c.__changeState__=tent.entities.ChangeStates.UNCHANGED}else{c=new tent.entities.EntityLink(a,d,b,tent.entities.ChangeStates.ADDED);this.context.changes.items.push(c)}}}};tent.entities.ContextChangeHandler.prototype.objectUnlinked=function(a,b,c,d){if(typeof d=="object")if(d instanceof Array){delete d.__parent__;
delete d.__propertyName__;tent.changes.unbind(d,this);c.onUnlinkRemove&&this.context.remove.apply(this.context,d)}else if(d!==null&&typeof d!="undefined"){c.onUnlinkRemove&&d.__collection__&&d.__collection__.remove(d);if(c.trackLinks){c=null;for(var g=-1,j=this.context.changes.items.length-1;j>=0;j--){var e=this.context.changes.items[j];if(e instanceof tent.entities.EntityLink&&e.from===a&&e.to===d&&e.propertyName==b){c=e;g=j;break}}if(c)if(c.__changeState__==tent.entities.ChangeStates.ADDED)this.context.changes.items.splice(g,
1);else{if(c.__changeState__!=tent.entities.ChangeStates.DELETED)c.__changeState__=tent.entities.ChangeStates.DELETED}else{c=new tent.entities.EntityLink(a,d,b,tent.entities.ChangeStates.DELETED);this.context.changes.items.push(c)}}}};tent.entities.ContextChangeHandler.prototype.getTrackedProperty=function(a,b){var c;if(a.__entityType__&&a.__changeState__&&a.__changeState__!=tent.entities.ChangeStates.DELETED&&a.__changeState__!=tent.entities.ChangeStates.DETACHED&&a.__collection__&&a.__collection__.context==
this.context&&(c=a.__entityType__.properties[b]))return c};tent.entities.ContextChangeHandler.prototype.handle=function(a){if(a.subject){var b;if(a.eventType==tent.changes.EventTypes.CHANGED)if(a.subject.__entityType__){if(b=this.getTrackedProperty(a.subject,a.data.propertyName)){this.context.touch(a.subject);this.objectUnlinked(a.subject,a.data.propertyName,b,a.data.oldValue);this.objectLinked(a.subject,a.data.propertyName,b,a.data.current)}}else this.context.touch(a.subject);else if(a.eventType==
tent.changes.EventTypes.ADDED){var c=a.subject.__parent__;if(c&&(b=this.getTrackedProperty(c,a.data.propertyName)))for(var d=0,g=a.data.items.length;d<g;d++)this.objectLinked(c,a.data.propertyName,b,a.data.items[d])}else if(a.eventType==tent.changes.EventTypes.REMOVED)if((c=a.subject.__parent__)&&(b=this.getTrackedProperty(c,a.data.propertyName))){d=0;for(g=a.data.items.length;d<g;d++)this.objectUnlinked(c,a.data.propertyName,b,a.data.items[d])}tent.changes.reverseProperties.getHandler()(a)}};tent.entities.ContextChangeHandler.prototype.init=
function(){if(this.context.log)var a=new tent.coreTypes.NameCounter;for(var b in this.context.__collections__){for(var c=this.context.__collections__[b],d=0,g=c.items.length;d<g;d++)this.itemAttached(c.items[d]);a&&a.add(b,c.items.length)}if(this.context.log)a&&a.root._count>0?tent.log.debug("Context: initialized with "+a):tent.log.debug("Context: initialized empty")};tent.entities.ContextChangeHandler.prototype.acceptAllChanges=function(){if(this.context.hasChanges()){this.context.log&&tent.log.debug("Context: accepting changes, "+
this.context.changes);for(var a=this.context.changes.items,b=0,c=a.length;b<c;b++)a[b].__changeState__=tent.entities.ChangeStates.UNCHANGED;a.length=0;this.context.log&&tent.log.debug("Context: all changes accepted")}};tent.entities.ContextChangeHandler.prototype.acceptChanges=function(){for(var a=0,b=arguments.length;a<b;a++){var c=arguments[a],d;if(typeof c=="number"){d=c;if(d<0||this.context.changes.items.length<d-1){c=null;d=-1}else c=this.context.changes.items[d]}else d=this.context.changes.items.lastIndexOf(c);
if(d>=0&&c){if(c.__changeState__===tent.entities.ChangeStates.ADDED||c.__changeState__===tent.entities.ChangeStates.MODIFIED){this.context.changes.items.splice(d,1);c.__changeState__=tent.entities.ChangeStates.UNCHANGED;if(c.__syncState__&&c.__syncState__.changedWhileSaving){delete c.__syncState__;this.context.touch(c)}}else if(c.__changeState__===tent.entities.ChangeStates.DELETED){this.context.changes.items.splice(d,1);c.__changeState__=tent.entities.ChangeStates.DETACHED}delete c.__syncState__}}};
tent.entities.getIdPropertyName=function(a){if(a.__entityType__)return a.__entityType__.getIdPropertyName(a);else{if(a.__collection__)return a.__collection__.context.getIdPropertyName(a);if(typeof a.id!="undefined")return"id";if(typeof a._id!="undefined")return"_id"}};tent.entities.getId=function(a){var b=tent.entities.getIdPropertyName(a);if(b)return a[b]}});tent.declare("tent.connectors",function(){});tent.declare("tent.connectors.http",function(){tent.connectors.http.uriCombine=function(){for(var a="",b=0,c=arguments.length;b<c;b++){var d;if(d=typeof arguments[b]=="undefined"||arguments[b]===null?"":arguments[b]+"")if(d.match(/^[A-Za-z]+\:\/\//))a=d;else{var g=a.indexOf("?"),j=a.indexOf("#");if(j>=0&&(g<0||g>j))g=j;if(g>=0)a=a.substr(0,g);a+=a.substr(a.length-1,1)=="/"?d.substr(0,1)=="/"?d.substr(1):d.substr(0,2)=="./"?d.substr(2):d:d.substr(0,1)=="/"?d:d.substr(0,2)=="./"?d.substr(1):"/"+d}}return a};
tent.connectors.http.requestDefaultOptions={type:"GET",cache:false};tent.connectors.http.request_nodejs=function(){throw"http request using node.js not implemented";};tent.connectors.http.request_jquery=function(a,b){if(typeof jQuery=="undefined")throw"jQuery is required for ajax requests";var c=tent.combineOptions(tent.connectors.http.requestDefaultOptions,a);jQuery.ajax({context:{options:c,callback:b},url:tent.connectors.http.uriCombine(c.baseUrl,c.url),beforeSend:function(d){if(c.auth){if(typeof Base64==
"undefined")throw"Base64 is required for http basic authentication";var g=Base64.encode(c.username+":"+c.password);d.setRequestHeader("Origin",document.location.protocol+"//"+document.location.host);d.setRequestHeader("Authorization","Basic "+g)}},type:c.type,cache:!!c.cache,dataType:"json",contentType:"application/json",data:JSON.stringify(c.data),headers:c.headers,timeout:c.timeout,username:c.username,password:c.password,success:function(d,g,j){typeof this.callback=="function"&&this.callback({ok:true,
data:d,req:j})},error:function(d,g,j){if(typeof this.callback=="function")this.callback({error:j||"error",req:d})}})};tent.connectors.http.request=tent.connectors.http.request_jquery});tent.declare("tent.connectors.rest",function(){tent.connectors.rest.RestConnector=function(){this.provider="Custom REST";this.baseUrl=null;this.loading=this.saving=false;this.options={entityLinkUrl:"_links",load:{http:{}},saveChanges:{bulk:true,bulkUrl:"_bulk",useCollectionInUrl:true,revisionProperty:"_rev",http:{type:"POST"}}};this.auth={username:"",password:""};this.filters={load:[],saveChanges:[],saveResult:[]};this.processors={load:[],saveResult:[]};this.processors.load.push(tent.connectors.rest.processors.load.defaultLoader);
this.processors.saveResult.push(tent.connectors.rest.processors.saveResult.saveResultReceiveByPosition);this.filters.saveChanges.push(tent.connectors.rest.filters.saveChanges.packChanges,tent.connectors.rest.filters.saveChanges.setUrlAndMethod)};tent.connectors.rest.RestConnector.createdb=function(a){tent.connectors.http.request({url:this.baseUrl,type:"PUT"},a)};tent.connectors.rest.RestConnector.deletedb=function(a){tent.connectors.http.request({url:this.baseUrl,type:"DELETE"},a)};tent.connectors.rest.RestConnector.prototype.filterData=
function(a){if(typeof a.action=="string"&&this.filters[a.action]&&this.filters[a.action].length>0)for(var b=this.filters[a.action],c=0,d=b.length;c<d;c++)a=b[c](a);return a};tent.connectors.rest.RestConnector.prototype.process=function(a){if(typeof a.action=="string"&&this.processors[a.action]&&this.processors[a.action].length>0)for(var b=this.processors[a.action],c=0,d=b.length;c<d;c++)b[c](a);return a};tent.connectors.rest.RestConnector.prototype.load=function(a,b,c,d){var g={action:"load"},j=this;
try{if(typeof c=="function"){d=c;c=null}g.options=tent.combineOptions(this.options,this.options.load,c);g.options.url=b||g.options.url;if(!g.options.baseUrl)g.options.baseUrl=this.baseUrl;if(!a)throw"a context is required for loading entities";if(!g.options.url)throw"an url must be specified to load";if(this.saving)throw"cannot load while saving";if(this.loading)throw"already loading entities";this.loading=true;g.options.context=a;tent.connectors.http.request(tent.combineOptions(g.options,g.options.http),
function(f){if(f.error)g.error=f.error;else{g.data=f.data;g.req=f.req;g=j.filterData(g);j.process(g);if(!g.error)g.ok=true}j.loading=false;d&&d(g)})}catch(e){this.loading=false;g.error=e;d&&d(g)}};tent.connectors.rest.RestConnector.prototype.saveChanges=function(a,b,c){var d={action:"saveChanges"},g=this;try{if(typeof b=="function"){c=b;b=null}d.options=tent.combineOptions(this.options,this.options.saveChanges,b);if(!d.options.baseUrl)d.options.baseUrl=this.baseUrl;if(!a)throw"a context is required for saving changes";
if(this.saving)throw"already saving changes";if(this.loading)throw"cannot save while loading";this.saving=true;d.options.context=a;d=g.filterData(d);if(d.data){d.options.data=d.data;tent.connectors.http.request(tent.combineOptions(d.options,d.options.http),function(e){if(e.error)d.error=e.error;else{d.qdata=d.data;d.data=e.data;d.req=e.req;d.action="saveResult";d=g.filterData(d);g.process(d);if(!d.error)d.ok=true}g.saving=false;c&&c(d)})}else{d.noop=true;if(!d.error)d.ok=true;c&&c(d)}}catch(j){this.saving=
false;d.error=j;c&&c(d)}};tent.connectors.rest.processors={load:{defaultLoader:function(a){if(!(a.action!="load"&&a.action!="saveResult"))for(var b,c,d,g,j=0,e=a.data.items.length;j<e;j++){c=a.data.items[j];d=false;g=(b=a.options.collection?a.options.collection:a.options.discriminatorProperty?doc[a.options.discriminatorProperty]:null)?a.options.context.getCollection(b):null;b=(g||a.options.context).find(c);if(c._deleted)if(b){if(b.__changeState__!==tent.entities.ChangeStates.MODIFIED){(g||a.options.context).remove(b);
(g||a.options.context).detach(b);d=true}}else d=true;else if(b){if(!(b.__changeState__===tent.entities.ChangeStates.MODIFIED||b.__changeState__===tent.entities.ChangeStates.DELETED)){tent.pset(b,c,true);a.options.context.changeHandler&&a.options.context.changeHandler.trackComplexProperties(b);d=true}}else{(g||a.options.context).attach(c);d=true}if(d){a.data.items.splice(j,1);j--;e--}}}},saveResult:{saveResultReceiveByPosition:function(a){if(a.action=="saveResult")if(!(!a.packedChanges||!a.packedChanges.length>
0)){for(var b,c,d=0,g=a.packedChanges.length;d<g;d++){b=a.packedChanges[d];if(c=a.data.items[d])if(b.__changeState__===tent.entities.ChangeStates.DELETED)if(c.deleted||c._deleted)a.options.context.acceptChanges(b);else{b.__syncState__.saving=false;b.__syncState__.error=c.error||"no delete response";b.__syncState__.message=c.message;b.__syncState__.reason=c.reason}else if(c.error){b.__syncState__.saving=false;b.__syncState__.error=c.error;b.__syncState__.message=c.message;b.__syncState__.reason=c.reason}else{a.options.context.acceptChanges(b);
if(b.__changeState__===tent.entities.ChangeStates.UNCHANGED){tent.pset(b,c,true);a.options.context.changeHandler&&a.options.context.changeHandler.trackComplexProperties(b)}}else{b.__syncState__.saving=false;b.__syncState__.error="noresponse";b.__syncState__.reason="no response from server"}}a.data.items.splice(0,a.packedChanges.length)}}}};tent.connectors.rest.filters={saveChanges:{packChanges:function(a){if(a.action!="saveChanges")return a;if(a.options.context.hasChanges())for(var b=-1,c=function(){if(a.options.maxCount&&
a.data&&a.data.items&&a.data.items.length>=a.options.maxCount)return false;if(a.options.bulk===false&&a.data&&a.data.items&&a.data.items.length>0)return false;b++;if(b>=a.options.context.changes.items.length)return false;if(!a.data)a.data={};if(!a.data.items)a.data.items=[];var d=a.options.context.changes.items[b],g;if(d instanceof tent.entities.EntityLink){g={_link:true,from:tent.entities.getId(d.from),to:tent.entities.getId(d.to),property:d.propertyName};if(d.__changeState__===tent.entities.ChangeStates.DELETED)g._deleted=
true}var j=tent.entities.getIdPropertyName(d);g=d.__changeState__===tent.entities.ChangeStates.DELETED?{_deleted:true}:tent.clone(d,{deep:true,onlyOwnProperties:true,attachedObjectsIds:true,attachedObjects:false,skipPrivates:true});if(j&&d[j])g[j]=tent.pget(d,j);if(a.options.revisionProperty)g[a.options.revisionProperty]=tent.pget(d,a.options.revisionProperty);if(a.options.discriminatorProperty&&d.__collection__)g[a.options.discriminatorProperty]=d.__collection__.name;if(g=g){a.data.items.push(g);
a.options.context.markAsSaving(d);if(!a.packedChanges)a.packedChanges=[];a.packedChanges.push(d)}return true};c(););return a},setUrlAndMethod:function(a){if(a.action!="saveChanges")return a;if(!a.packedChanges||!a.packedChanges.length>0)return a;if(a.options.bulk||a.packedChanges.length>1){if(!(a.options.http.url||a.options.url))a.options.http.url=a.options.bulkUrl}else if(a.packedChanges.length==1){if(!(a.options.http.url||a.options.url)){var b=a.packedChanges[0],c="/";if(b instanceof tent.entities.EntityLink){if(a.options.entityLinkUrl)c=
tent.connectors.http.uriCombine(c,a.options.entityLinkUrl)}else if(a.options.useCollectionInUrl&&b.__collection__)c=tent.connectors.http.uriCombine(c,b.__collection__.name);var d=tent.entities.getId(b);if(typeof d!="undefined"){c=tent.connectors.http.uriCombine(c,d);a.options.http.type=b.__changeState__===tent.entities.ChangeStates.DELETED?"DELETE":"PUT"}else a.options.http.type="POST";a.options.http.url=c}a.data=a.data.items[0]}return a}}}});tent.declare("tent.connectors.couchdb",function(){tent.connectors.couchdb.CouchDBConnector=function(){var a=new tent.connectors.rest.RestConnector;a.couchdb=true;a.provider="CouchDB";a.options.saveChanges.bulk=true;a.options.saveChanges.bulkUrl="_bulk_docs";a.options.saveChanges.useCollectionInUrl=false;a.options.saveChanges.revisionProperty="_rev";a.filters.load.unshift(function(b){if(typeof b.data.rows=="object"&&b.data.rows instanceof Array&&typeof b.data.total_rows=="number"){b.data.items=[];
for(var c=0,d=b.data.rows.length;c<d;c++)b.data.items.push(b.data.rows[c].doc);delete b.data.rows}else b.data={total_rows:1,items:[b.data]};return b});a.filters.saveChanges.push(function(b){if(b.data&&b.data.items instanceof Array){for(var c=0,d=b.data.items.length;c<d;c++){var g=b.data.items[c];if(b.packedChanges&&b.packedChanges[c]&&b.packedChanges[c].__changeState__===tent.entities.ChangeStates.DELETED)g._deleted=true}b.data.docs=b.data.items;delete b.data.items}else if(b.data&&b.packedChanges&&
b.packedChanges.length===1)if(b.options.http.type==="DELETE"){if(!b.options.http.headers)b.options.http.headers={};b.packedChanges[0]._deleted=true;b.options.http.headers["If-Match"]=b.packedChanges[0][b.options.saveChanges.revisionProperty];b.options.http.url+="?rev="+b.packedChanges[0][b.options.saveChanges.revisionProperty];b.data={}}return b});a.filters.saveResult.unshift(function(b){for(var c=0,d=b.data.items.length;c<d;c++){var g=b.data.items[c];delete g.ok;g._id=g.id;delete g.id;g._rev=g.rev;
delete g.rev;if(!g.error&&b.packedChanges&&b.packedChanges[c]&&b.packedChanges[c].__changeState__===tent.entities.ChangeStates.DELETED)g._deleted=true}return b});a.filters.saveResult.unshift(function(b){b.data=typeof b.data=="object"&&b.data instanceof Array?{items:b.data}:{items:[b.data]};return b});return a}});
